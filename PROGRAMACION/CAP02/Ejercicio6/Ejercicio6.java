public class Ejercicio6 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("    "+ROJO+"APRENDE JAVA"+RESET+"       "+FONDO_ROJO+"   "+RESET);
        System.out.println("   "+ROJO+"CON EJERCICIOS"+RESET+"         "+FONDO_ROJO+"   "+RESET);
        System.out.println("                                               ");
        System.out.println("  "+AMARILLO+"Luis José Sánchez"+RESET+"   "+FONDO_AZUL+"                "+RESET+"  ");
        System.out.println("                      "+FONDO_AZUL+"          "+RESET+"   "+FONDO_AZUL+"   "+RESET+"   ");
        System.out.println("                      "+FONDO_AZUL+"                "+RESET+"   ");
        System.out.println("                      "+FONDO_AZUL+"          "+RESET+"   ");
        System.out.println(FONDO_PURPURA+"                      "+RESET+FONDO_AZUL+"          "+RESET+FONDO_PURPURA+"            "+RESET+"   ");
