...
public class ImageTransformerUtil {
    ...
    private static String obtenerCodigoAnsi(int value) {
        if (value<0 || value>255) {
            System.out.println("Error. El valor no se encuentra entre el rango de 0 y 255");
            return null;
        }
        return "\u001B[48;5;"+value+"m";
    }
    ...
    public static int[][] rotarIzquierda(int[][] matriz) {
        ...
        for (int i=0; i<matriz.length; i++) {
            for (int j=0; j<matriz[0].length; j++) {
                rotada[matriz[0].length-j-1][i] = matriz[i][j];
            }
        }
        return rotada;
    }
    ...
    public static int[][] espejoHorizontal(int[][] matriz) {
        ...
        for (int i=0; i<matriz.length; i++) {
            for (int j=0; j<matriz[0].length; j++) {
                rotada[i][matriz[0].length-j-1] = matriz[i][j];
            }
        }
        return rotada;
    }
    ...
    public static int[][] espejoVertical(int[][] matriz) {
        int[][] rotada = new int[matriz.length][matriz[0].length];
        for (int i=0; i<matriz.length; i++) {
            for (int j=0; j<matriz[0].length; j++) {
                rotada[matriz.length-i-1][j] = matriz[i][j];
            }
        }
        return rotada;
    }
    ...
    public static void imprimirEnColorMatriz(int[][] matriz) {
        for (int i=0; i<matriz.length; i++) {
            for (int j=0; j<matriz[0].length; j++) {
                System.out.print(obtenerCodigoAnsi(matriz[i][j])+"  "+ANSI_RESET);
            }
            System.out.println();
        }
    }
